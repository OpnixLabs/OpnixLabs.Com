      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={timelineRef} className="relative mb-20 md:mb-28">
          ...
          <motion.div
            ...
            className="absolute left-4 lg:left-1/2 top-4 -bottom-[120px] w-1 bg-gradient-to-b from-blue-400 via-sky-500 to-blue-600 -translate-x-1/2 hidden sm:block shadow-[0_0_12px_rgba(56,189,248,0.8)]"
          />
          ...
          <div className="space-y-16 sm:space-y-24 lg:space-y-32">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center pl-8 sm:pl-10 lg:pl-0">
              ...
              <div className="absolute left-4 lg:left-1/2 top-0 lg:top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 hidden sm:flex items-center justify-center">
                <div className="w-8 h-8 rounded-full bg-blue-500/20 border-2 mt-20 lg:mt-0 translate-x-0.5 border-blue-400 flex items-center justify-center shadow-[0_0_15px_rgba(6,182,212,0.6)] bg-white dark:bg-slate-900">
                  <div className="w-3 h-3 rounded-full bg-blue-400 animate-ping" />
                  <div className="w-2.5 h-2.5 rounded-full bg-blue-400 absolute" />
                </div>
              </div>
              ...
              >
                <span className="inline-block px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold tracking-wider uppercase">
                  {milestones[0].badge}
                </span>
              ...
              >
                <div className="relative h-56 sm:h-72 lg:h-80 w-full rounded-lg overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 sm:bottom-4 sm:left-4 sm:right-4 p-3 sm:p-4 rounded-lg bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border border-slate-200/80 dark:border-slate-800/80 shadow-xl transition-colors">
                    <p className="text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-blue-600 dark:text-blue-400">Engineering Standard</p>
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center pl-8 sm:pl-10 lg:pl-0">
              ...
              >
                {milestones[1].stats?.map((stat, idx) => (
                  <div 
                    key={idx} 
                    className="glass-panel p-4 sm:p-5 lg:p-6 rounded-xl border border-slate-200 dark:border-slate-800 text-center hover:border-blue-500/50 transition-colors shadow-md flex flex-col justify-center items-center overflow-hidden"
                  >
          ...
          <div className="absolute left-4 lg:left-1/2 -bottom-10 -translate-x-1/2 translate-y-1/2 z-10 hidden sm:flex items-center justify-center">
            <div className="w-8 h-8 rounded-full bg-blue-500/20 border-2 mt-10 translate-x-0.5 border-blue-400 flex items-center justify-center shadow-[0_0_18px_rgba(6,182,212,0.8)] bg-white dark:bg-slate-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {teamDisciplines.map((d, i) => (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="glass-panel p-6 rounded-xl space-y-4 border border-slate-200 dark:border-slate-800 hover:border-blue-500/40 transition-all shadow-lg"
              >
