...
const industrySectors = [
  { name: 'EdTech & LMS', category: 'Learning Platforms', icon: <Globe className="w-5 h-5 text-blue-600 dark:text-blue-400" /> },
  { name: 'FinTech Core', category: 'Banking & ACH APIs', icon: <Server className="w-5 h-5 text-blue-600 dark:text-blue-400" /> },
  { name: 'MarTech Platforms', category: 'E-Commerce & Reviews', icon: <Building2 className="w-5 h-5 text-blue-600 dark:text-blue-400" /> },
  { name: 'Enterprise SaaS', category: 'Multi-Tenant Systems', icon: <Cpu className="w-5 h-5 text-blue-600 dark:text-blue-400" /> },
  { name: 'Data Engineering', category: 'PostgreSQL & Realtime', icon: <Database className="w-5 h-5 text-blue-600 dark:text-blue-400" /> },
  { name: 'Cloud DevOps', category: 'AWS, GCP & Kubernetes', icon: <ShieldCheck className="w-5 h-5 text-blue-600 dark:text-blue-400" /> },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-16">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <motion.div
              ...
              className="glass-panel p-6 rounded-xl border border-blue-500/30 relative overflow-hidden group shadow-lg bg-white dark:bg-slate-900/80"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-10">
          {industrySectors.map((sector, idx) => (
            <motion.div
              ...
              className="glass-panel p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 flex flex-col items-center justify-center text-center space-y-2 hover:border-blue-500/40 transition-all shadow-md group"
            >
              <div className="p-2.5 rounded-lg bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                {sector.icon}
              </div>
              <span className="font-extrabold text-sm sm:text-base text-slate-900 dark:text-slate-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                {sector.name}
              </span>
